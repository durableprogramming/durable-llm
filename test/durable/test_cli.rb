...
class TestCLI < Minitest::Test
  ...
  def test_models_command
    ...
    Durable::Llm::Providers.expects(:providers).returns([:openai, :anthropic])
    
    Durable::Llm::Providers::Openai.expects(:models).returns(['gpt-3.5-turbo', 'gpt-4'])
    Durable::Llm::Providers::Anthropic.expects(:models).returns(['claude-2.1', 'claude-instant'])
  ...
  def test_models_command_with_options_flag
    ...
    Durable::Llm::Providers::Openai.expects(:models).returns(['gpt-3.5-turbo'])
